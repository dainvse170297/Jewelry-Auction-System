...
export default function LiveLotDetail() {
  ...
  // }
  // const sessionId = getQueryParameter("id");

  // const handleGoBackClick = (e) => {
  //   e.preventDefault()
  //   if (sessionId) {
  //     navigate(`/live-session-detail/${sessionId}`);
  //   }
  // }
          ...
          <div className="row mt-5">
            ...
            <div className="col-lg-6">
              ...
              <div className="item-infor mt-5">
                <h4 className="text-center"><strong>{productInfo.productName}</strong></h4>
                ...
                <div className="d-flex justify-content-center mt-5">
                  <div className="d-flex align-items-center">
                    <h4 className="me-3">Current Price: $ {productInfo.currentPrice === null ? 0 : productInfo.currentPrice}</h4>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-6">
              <div className="bid-panel">
                ...
                <div className="d-flex justify-content-center">
                  <button onClick={calculateBid} className="bid-btn">PLACE BID</button>
                </div>
                <ToastContainer />
              </div>
              ...
              <div className="bid-history">
                ...
                {bidHistory.map((item, index) => (
                  <div key={index} className="">
                    <p >${item.price} <span>{moment(item.bidTime).format('YYYY-MM-DD HH:mm')}</span></p>
                  </div>
                ))}
              </div>
            </div>
