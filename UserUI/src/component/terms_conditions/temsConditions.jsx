...
const TermsAndConditions = () => {
  return (
    <div className="terms-conditions container py-5">
      ...
      <div className="content-section">
        <h5 className="section-title">Restrictions</h5>
        ...
        <ul>
          ...
          <li>
            Using this website to engage in any advertising or marketing without
            our consent.
          </li>
        </ul>
      </div>
      <div className="content-section">
        ...
        <ul>
          <li>
            If you win the auction, you are required to pay an additional 20%
            service fee on top of your winning bid amount.
          </li>
          <li>
            Payment must be completed within 7 days of winning the auction.
            Failure to complete the payment within this period may result in the
            cancellation of your bid and the item being offered to the next
            highest bidder.
          </li>
          <li>
            All payments must be made using the payment methods specified on our
            site. We accept major credit cards and other secure payment methods.
          </li>
          <li>
            If you have any issues with the payment process, please contact our
            support team immediately for assistance.
          </li>
          <li>
            By placing a bid, you confirm that you have sufficient funds to
            cover your bid amount plus the additional service fee.
          </li>
        </ul>
      </div>
      <div className="content-section">
        <h5 className="section-title">Your Content</h5>
        <p>
      ...
      <div className="content-section">
        <h5 className="section-title">Severability</h5>
        <p>
      ...
      <div className="content-section">
        <h5 className="section-title">Governing Law & Jurisdiction</h5>
        <p>
