    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-md-6">
          ...
          <p>
            FU AUCTION has been specifically designed to protect your interests
            and maximize your results in the shortest possible timeframe. With
            our unique model, we are at the forefront of revolutionizing the
            industry, merging the tried-and-true methods of traditional auction
            houses with the dynamism of modern innovative marketplace models,
            utilizing cutting-edge technology and focusing on an unyielding
          ...
          <div>
            <p className="text-center slogan md-5">
              " FU Auction is a classy company that is laser-focused on giving
              the seller the best experience possible... they do exactly what
        ...
        <div className="col-md-6 text-center">
          ...
          <img
            src="https://res.cloudinary.com/dhkmu458i/image/upload/v1718964404/slo1rvsyygsztnmqzpr4.jpg"
          ...
          <p>
            To continue learning about selling with FORTUNA, keep scrolling and
            reading.
          </p>
        </div>
      </div>
      ...
      <div className="text-center md-5 my-5">
        ...
        know. The following sections will highlight what makes FORTUNA different
        and answer the question, “Why FORTUNA?”, as well as walk you through the
        entire process from start to finish. This guide is designed to prepare
        you thoroughly for your selling journey with FORTUNA, giving you the
        confidence to make informed decisions at every step of the way.
      </div>
        ...
        <div className="col-md-12">
          ...
          <div className="my-5 whysell">
            <p>
              ...
              challenging and confusing process, but it doesn’t have to be. With
              FORTUNA by your side, you can rest assured that your valuable
              assets are in the best hands possible.
            </p>
            <p>
            ...
            <p>
              ...
              accountability, and excellence are at the forefront of everything
              we do. We believe our values, performance, and reputation set us
              far apart from our competitors.
            </p>
            <p>
              Here are the five (5) reasons that answer the question, “Why Sell
              with FORTUNA?”:
            </p>
          </div>
        </div>
      ...
      <div className="row my-5">
        ...
        <div className="col-md-6 text-center">
          <img
            src="https://res.cloudinary.com/dhkmu458i/image/upload/v1719905855/a5ts1g9ctmbynjw85rf0.jpg"
            alt="Auction FU Image"
            className="img-fluid"
      ...
      <div className="row my-5">
        ...
        <div className="col-md-6 text-center">
          <img
            src="https://res.cloudinary.com/dhkmu458i/image/upload/v1719859276/hpwj0xicsh9i7ktuhumy.jpg"
            alt="Auction FU Image"
            className="img-fluid"
            style={{ maxWidth: "350px", maxHeight: "350px" }}
          />
      ...
      <div className="row my-5">
        ...
        <div className="col-md-6 text-center">
          <img
            src="https://res.cloudinary.com/dhkmu458i/image/upload/v1719859147/xoqwm1qwntkf9cqrp4cl.jpg"
            alt="Auction FU Image"
            className="img-fluid"
            style={{ maxWidth: "350px", maxHeight: "350px" }}
          />
      ...
      <div className="row my-5">
        ...
        <div className="col-md-6 text-center">
          <img
            src="https://res.cloudinary.com/dhkmu458i/image/upload/v1719859177/wlrwva02polv8lcoyq9d.jpg"
            alt="Auction FU Image"
            className="img-fluid"
            style={{ maxWidth: "350px", maxHeight: "350px" }}
          />
          <p className="img-content">
            Exceptionally Rare Type IIA D/IF 6.01-Carat Emerald-Cut Diamond, GIA
            Certified with Mounting Sold at FORTUNA for $260,000
          </p>
        </div>
      </div>
      ...
      <div className="row my-5">
        ...
        <div className="col-md-6 text-center">
          <img
            src="https://res.cloudinary.com/dhkmu458i/image/upload/v1719909868/Belperron-vintage-Pagoda-Bib-Necklace_cntnip.jpg"
            alt="Auction FU Image"
            className="img-fluid"
            style={{ maxWidth: "350px", maxHeight: "350px" }}
          />
      ...
      <div className="text-center md-5 my-5">
        ...
        <p>
          Now that you understand why selling with FU AUCTION is a smart choice,
          let’s delve into the process itself. We have broken down the process
          into seven clear, easy-to-understand steps to make sure you are
          well-prepared and confident every step of the way.
        </p>
      </div>
        ...
        <div className="col-md-4">
          <div className="step">
            ...
            <p>
              ...
              experienced team will understand your needs and provide you with
              tailored advice.
            </p>
          </div>
        </div>
      ...
      <div className="row">
        <div className="col-md-4">
          <div className="step">
            ...
            <p>
              We prepare your items for auction with professional photography,
        ...
        <div className="col-md-4">
          <div className="step">
            ...
            <p>
              We handle all post-auction logistics, including payment processing
              and item delivery to buyers.
            </p>
          </div>
        </div>
      </div>
      <div className="row my-5">
        <div className="col-md-12">
          <div className="step text-center">
            ...
            <p>
              Finally, we ensure you receive your proceeds promptly and provide
              a detailed settlement report for your records.
            </p>
          </div>
        </div>
      </div>
