...
CREATE TABLE member (
  ...
  financial_proof_id     int(10) NOT NULL, 
...
ALTER TABLE `valuation request` ADD CONSTRAINT `FKvaluation 848653` FOREIGN KEY (response_id) REFERENCES response (response_id);
ALTER TABLE `valuation request` ADD CONSTRAINT `FKvaluation 263327` FOREIGN KEY (member_id) REFERENCES member (member_id);
ALTER TABLE product ADD CONSTRAINT FKproduct778237 FOREIGN KEY (request_id) REFERENCES `valuation request` (valuation_request_id);
