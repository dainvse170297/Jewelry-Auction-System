...
public class DashboardService implements IDashboardService {
    ...
    private final Map<Integer,Integer> totalLotJoinAuctionSession = new HashMap<>();
    private final Map<Integer,Integer> totalLotSoldAuctionSession = new HashMap<>();


    @Override
    public Long[] getRevenueEachMonthOfCurrentYear() {
        return getRevenueEachMonthOfYear(LocalDate.now().getYear());
    }
...
//    }
    ...
    private Long[] getRevenueEachMonthOfYear(int year) {
        ...
        totalLotJoinAuctionSession.put(year, totalLotJoinToAuction);
        totalLotSoldAuctionSession.put(year, totalLotSold);
